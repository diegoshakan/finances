...
save_money2 = FactoryBot.create(:save_money, title: 'BB', description: 'Seed Data', user: user1)
save_money3 = FactoryBot.create(:save_money, title: 'inter', description: 'Seed Data', user: user2)
